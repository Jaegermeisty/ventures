    ...
    <div className="min-h-screen" style={{ background: "#1C1C1E" }}>
      ...
      <main className="relative mx-auto max-w-3xl px-6 py-16 sm:py-24">
        ...
        <header className="mb-12 text-center">
          ...
          {/* Tab switcher */}
          <div
            className="mx-auto mt-8 inline-flex rounded-full p-1"
          ...
          >
            <button
              ...
              style={{
                backgroundColor:
                  activeTab === "privacy" ? "#FF9500" : "transparent",
                color: activeTab === "privacy" ? "#1C1C1E" : "#8E8E93",
              }}
            >
              Privacy Policy
            </button>
            <button
              ...
              style={{
                backgroundColor:
                  activeTab === "support" ? "#FF9500" : "transparent",
                color: activeTab === "support" ? "#1C1C1E" : "#8E8E93",
              }}
            >
              Support
            </button>
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} Jaeger&#8209;Pedersen Ventures.
            All rights reserved.
          </p>
        </footer>
      </main>
...
function PrivacyContent() {
  return (
    <>
      <h1
        className="font-display mb-8 text-center text-4xl font-bold leading-tight sm:text-5xl"
        style={{ color: "#FFFFFF" }}
      >
        Privacy Policy
      </h1>
      <p className="mb-8 text-center text-base" style={{ color: "#8E8E93" }}>
      ...
      >
        <p
          ...
          style={{ color: "#D1D1D6" }}
        >
          Jaeger&#8209;Pedersen Ventures (&ldquo;we,&rdquo; &ldquo;us,&rdquo;
          or &ldquo;our&rdquo;) operates the Summit: Workout Tracker app (the
          &ldquo;App&rdquo;). This Privacy Policy explains how we handle your
          information.
        </p>
      </section>
      ...
      <div className="space-y-6">
        ...
        <PolicyCard number={2} title="Data Storage and Backups">
          ...
          <p className="mt-4">
            ...
            include the App&apos;s local data in those backups. We do not control
            or access those backups.
          </p>
        </PolicyCard>

        <PolicyCard number={3} title="Analytics and Tracking">
          <p>We do not use third&#8209;party analytics or tracking tools.</p>
          <p className="mt-4">
        ...
        <PolicyCard number={6} title="Data Retention">
          <p>
            Your workout data remains on your device until you delete the App or
            remove the data.
          </p>
        </PolicyCard>
    ...
    <>
      ...
      >
        <h2
          ...
          style={{ color: "#FFFFFF" }}
        >
          Support — Summit: Workout Tracker
        </h2>
        <p
          className="font-body text-base leading-relaxed sm:text-lg"
          style={{ color: "#D1D1D6" }}
        >
          Need help, feedback, or found a bug?
        </p>
      </section>
